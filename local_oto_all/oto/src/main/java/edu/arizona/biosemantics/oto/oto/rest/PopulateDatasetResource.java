...
public class PopulateDatasetResource {
	...
	public String groupTerms(@PathParam("datasetName") String datasetName, NameContextData content) {		
	...
	public String structureHierarchy(@PathParam("datasetName") String datasetName, NameContextData content) {		
	...
	public String termOrder(@PathParam("datasetName") String datasetName, TermOrderData content) {
